            ...
            <div v-if="showPostModal" class="p-modal">
                <div class="p-container">
                    ...
                    <div v-show="postComments.length" class="comments">
                        <div v-for="comment in postComments" :key="comment.postId" class="comment">
    ...
    export default {
        ...
        methods: {
            ...
            addComment() {
                ...
                let postComments = self.comment.postComments
            ...
            likePost(postId, postLikes) {
                let self = this
                let docId = `${self.currentUser.uid}_${postId}`
            ...
            viewPost(post) {
                ...
                firebase.commentsCollection.where('postId', '==', post.id).get().then(docs => {
                    let commentsArray = []
